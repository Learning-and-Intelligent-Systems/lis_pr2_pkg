...
if __name__=="__main__":
    ...
    def keyboard_controller():
        ...
        def KEYCODE_2(event):
            print("Keycode 2")
            uc.command_joint_pose("r", [-np.pi/2, 0, 0, 0, 0, 0, 0 ], 3, False)
            uc.command_joint_pose("l", [np.pi/2, 0, 0, 0, 0, 0, 0 ], 3, False)

        def KEYCODE_3(event):
            print("Keycode 3")
            uc.command_joint_pose("r", [-np.pi/2, 0, -np.pi, -np.pi/2, 0, 0, 0 ], 3, False)
            uc.command_joint_pose("l", [np.pi/2, 0, np.pi, -np.pi/2, 0, 0, 0 ], 3, False)

        def KEYCODE_4(event):
            print("Keycode 4")
            uc.command_joint_pose("r", [0]*7, 3, False)
            uc.command_joint_pose("l", [0]*7, 3, False)
        ...
        frame.bind("<x>", KEYCODE_2)
        frame.bind("<c>", KEYCODE_3)
        frame.bind("<v>", KEYCODE_4)
